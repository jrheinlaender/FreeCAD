...
struct ShapeRef {
   ...
   enum typeEnum {
       ...
       /// Shapes generated by sketch geometry
       GeometryVtx = 101,
       GeometryVertex = 102,
       GeometryEdge = 103,
       GeometryFace = 104,
